...
class ExcavatorWorkServerIntegrationTests(TestCase):
    ...
    def test_excavator_work_uses_project_realtime_and_reference_data(self):
        ...
        self.assertContains(response, 'excavator-mobile-shell-v250')
        self.assertContains(response, '/static/js/excavator-field-outbox-v1.js?v=excavator-mobile-shell-v250')
        ...
        self.assertContains(response, 'Версия 250')
    ...
    def test_excavator_service_worker_caches_mobile_shell(self):
        ...
        self.assertIn('excavator-mobile-shell-v250', script)
        self.assertIn(
        ...
        self.assertIn(
            '/static/js/excavator-field-outbox-v1.js?v=excavator-mobile-shell-v250',
            script,
        )
        ...
        self.assertIn('/static/audio/excavator/excavator_assignment_notice.wav', script)
        self.assertIn('/static/audio/excavator/excavator_action_success_notice.wav', script)
        self.assertIn('/static/audio/excavator/excavator_assignment_removed_notice.wav', script)
        self.assertIn('/static/audio/excavator/excavator_shift_notice.wav', script)
        self.assertIn('/static/audio/excavator/excavator_action_failed_notice.wav', script)
        self.assertIn('/static/audio/excavator/excavator_connection_lost_notice.wav', script)
        self.assertIn('/static/audio/excavator/excavator_connection_restored_notice.wav', script)
