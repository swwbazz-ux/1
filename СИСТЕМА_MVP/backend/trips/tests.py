...
class ExcavatorWorkServerIntegrationTests(TestCase):
    ...
    def test_excavator_work_uses_project_realtime_and_reference_data(self):
        ...
        self.assertContains(response, 'excavator-mobile-shell-v107')
        self.assertContains(response, 'class="eo-current-app-version" aria-label="Текущая версия приложения">v107</span>')
    ...
    def test_excavator_service_worker_caches_mobile_shell(self):
        ...
        self.assertIn('excavator-mobile-shell-v107', script)
