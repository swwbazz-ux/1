...
class ExcavatorWorkServerIntegrationTests(TestCase):
    ...
    def test_excavator_work_uses_project_realtime_and_reference_data(self):
        ...
        self.assertContains(response, 'excavator-mobile-shell-v209')
        ...
        self.assertContains(response, 'playExcavatorVoice("truck_assigned", voice || "voice_truck_assigned"')
    ...
    def test_excavator_service_worker_caches_mobile_shell(self):
        ...
        self.assertIn('excavator-mobile-shell-v209', script)
        self.assertIn(
