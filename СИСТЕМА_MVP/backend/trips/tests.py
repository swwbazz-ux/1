...
class ExcavatorWorkServerIntegrationTests(TestCase):
    ...
    def test_excavator_work_uses_project_realtime_and_reference_data(self):
        ...
        self.assertContains(response, 'excavator-mobile-shell-v199')
        ...
        self.assertContains(response, 'Версия 199')
    ...
    def test_excavator_service_worker_caches_mobile_shell(self):
        ...
        self.assertIn('excavator-mobile-shell-v199', script)
        ...
        self.assertIn('/static/css/excavator-login-v1.css', script)
        ...
        self.assertIn('/static/js/excavator-sounds-v1.js', script)
