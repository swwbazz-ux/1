...
DEMO_USERS = [
    ...
    ('Табельщик MVP', 'timekeeper', '900000', '+79000000009'),
    ('Начальник участка MVP', 'site_manager', '910000', '+79000000010'),
    ('Сотрудник MVP', 'employee_portal', '920000', '+79000000011'),
]
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if options['with_demo_users']:
            ...
            self.stdout.write(
                'Демо-доступы созданы: 100000, 200000, 300000, 400000, '
                '500000, 600000, 700000, 800000, 900000, 910000, 920000'
            )
