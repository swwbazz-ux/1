...
STATIC_ASSET_RELEASE = 'ready-core-traffic-v23'
...
ROLE_APPS = (
    RoleApp(
        ...
        shell_version='driver-mobile-shell-v162',
    ),
    RoleApp(
        ...
        shell_version='excavator-mobile-shell-v153',
    ),
    RoleApp(
        ...
        shell_version='mining-master-mobile-shell-v132',
    ),
    RoleApp(
