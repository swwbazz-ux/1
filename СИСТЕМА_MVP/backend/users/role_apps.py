...
STATIC_ASSET_RELEASE = 'ready-core-traffic-v28'
...
ROLE_APPS = (
    RoleApp(
        ...
        shell_version='driver-mobile-shell-v165',
    ),
    RoleApp(
        ...
        shell_version='excavator-mobile-shell-v159',
    ),
    RoleApp(
        ...
        shell_version='mining-master-mobile-shell-v137',
    ),
    RoleApp(
