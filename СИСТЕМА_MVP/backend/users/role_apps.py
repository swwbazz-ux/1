...
STATIC_ASSET_RELEASE = 'ready-core-traffic-v105'
...
ROLE_APPS = (
    RoleApp(
        ...
        shell_version='driver-mobile-shell-v197',
    ),
    RoleApp(
        ...
        shell_version='excavator-mobile-shell-v210',
    ),
    RoleApp(
        ...
        shell_version='mining-master-mobile-shell-v140',
    ),
    RoleApp(
