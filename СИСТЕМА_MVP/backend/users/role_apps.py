...
STATIC_ASSET_RELEASE = 'ready-core-traffic-v21'
...
ROLE_APPS = (
    RoleApp(
        ...
        shell_version='driver-mobile-shell-v161',
    ),
    RoleApp(
        ...
        shell_version='excavator-mobile-shell-v149',
    ),
    RoleApp(
        ...
        shell_version='mining-master-mobile-shell-v131',
    ),
    RoleApp(
