...
STATIC_ASSET_RELEASE = 'ready-core-traffic-v25'
...
ROLE_APPS = (
    RoleApp(
        ...
        shell_version='driver-mobile-shell-v164',
    ),
    RoleApp(
        ...
        shell_version='excavator-mobile-shell-v155',
    ),
    RoleApp(
        ...
        shell_version='mining-master-mobile-shell-v133',
    ),
    RoleApp(
