...
STATIC_ASSET_RELEASE = 'ready-core-traffic-v100'
...
ROLE_APPS = (
    RoleApp(
        ...
        shell_version='driver-mobile-shell-v196',
    ),
    RoleApp(
        ...
        shell_version='excavator-mobile-shell-v206',
    ),
    RoleApp(
    ...
    RoleApp(
        ...
        shell_version='system-admin-shell-v22',
    ),
)
