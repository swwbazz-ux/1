...
STATIC_ASSET_RELEASE = 'ready-core-traffic-v157'
...
ROLE_APPS = (
    RoleApp(
        ...
        shell_version='driver-mobile-shell-v214',
    ),
    RoleApp(
        ...
        shell_version='excavator-mobile-shell-v234',
    ),
    RoleApp(
    ...
    RoleApp(
        ...
        shell_version='dispatcher-desktop-shell-v104',
    ),
    RoleApp(
