...
STATIC_ASSET_RELEASE = 'ready-core-traffic-v184'
...
ROLE_APPS = (
    RoleApp(
        ...
        shell_version='driver-mobile-shell-v338',
    ),
    RoleApp(
        ...
        shell_version='excavator-mobile-shell-v252',
    ),
    RoleApp(
        ...
        shell_version='mining-master-mobile-shell-v164',
    ),
    RoleApp(
        ...
        shell_version='deputy-mining-manager-desktop-shell-v17',
    ),
    RoleApp(
        ...
        shell_version='dispatcher-desktop-shell-v131',
    ),
    RoleApp(
