...
STATIC_ASSET_RELEASE = 'ready-core-traffic-v10'
...
ROLE_APPS = (
    RoleApp(
        ...
        shell_version='driver-mobile-shell-v115',
    ),
    RoleApp(
    ...
    RoleApp(
        ...
        shell_version='mining-master-mobile-shell-v121',
    ),
    RoleApp(
    ...
    RoleApp(
        ...
        shell_version='dispatcher-desktop-shell-v45',
    ),
    RoleApp(
