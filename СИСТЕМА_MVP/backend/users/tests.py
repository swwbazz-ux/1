...
class AccessLoginTests(TestCase):
    ...
    def test_driver_screen_includes_own_pwa_install_metadata(self):
        ...
        self.assertContains(response, 'driver-mobile-shell-v227')
        self.assertContains(response, '/static/js/mobile-operational-sounds-v1.js')
        self.assertContains(
            response,
            '/static/js/driver-offline-outbox-v2.js?v=driver-mobile-shell-v227',
        )
        self.assertContains(
            response,
            '/static/css/mobile-shift-unified-v1.css?v=driver-mobile-shell-v227',
        )
        self.assertContains(
            response,
            '/static/js/mobile-shift-unified-v1.js?v=driver-mobile-shell-v227',
        )
    ...
    def test_driver_service_worker_caches_driver_assets_and_reports_version(self):
        ...
        self.assertIn('driver-mobile-shell-v227', script)
        self.assertIn(
    ...
    def test_driver_sees_truck_loaded_event_from_excavator_realtime_shell(self):
        ...
        self.assertContains(driver_shift_response, 'driver-mobile-shell-v227')
