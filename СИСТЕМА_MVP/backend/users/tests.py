...
class AccessLoginTests(TestCase):
    ...
    def test_driver_active_shift_uses_excavator_shift_layout(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, 'class="driver-shift-workspace mobile-shift"')
        self.assertContains(response, 'Показатели техники')
        self.assertContains(response, 'Итог смены')
        ...
        self.assertContains(response, 'mobile-shift__assignment')
        ...
        self.assertContains(response, '--mobile-shift-reading-size: clamp(88px, 10.2svh, 106px);')
        self.assertContains(
            response,
            'grid-template-rows: repeat(3, var(--mobile-shift-reading-size));',
        )
        self.assertContains(response, 'overflow-y: auto !important;')
        self.assertContains(response, 'margin: 0;')
    ...
    def test_driver_screen_includes_own_pwa_install_metadata(self):
        ...
        self.assertContains(response, 'driver-mobile-shell-v175')
    ...
    def test_driver_service_worker_caches_driver_assets_and_reports_version(self):
        ...
        self.assertIn('driver-mobile-shell-v175', script)
    ...
    def test_driver_sees_truck_loaded_event_from_excavator_realtime_shell(self):
        ...
        self.assertContains(driver_shift_response, 'driver-mobile-shell-v175')
