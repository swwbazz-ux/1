...
class AccessLoginTests(TestCase):
    ...
    def test_driver_screen_includes_own_pwa_install_metadata(self):
        ...
        self.assertContains(response, 'driver-mobile-shell-v195')
        ...
        self.assertContains(response, 'announceDumpPoint')
        self.assertContains(response, 'operational-state-refresh-applied')
        self.assertContains(response, 'payload.action !== "truck_loaded"')
        self.assertContains(response, 'driverAppliedActionSound(actionKind, freshShell)')
    ...
    def test_driver_service_worker_caches_driver_assets_and_reports_version(self):
        ...
        self.assertIn('driver-mobile-shell-v195', script)
        self.assertIn(
    ...
    def test_driver_sees_truck_loaded_event_from_excavator_realtime_shell(self):
        ...
        self.assertContains(driver_shift_response, 'driver-mobile-shell-v195')
