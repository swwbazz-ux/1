...
class AccessLoginTests(TestCase):
    ...
    def test_driver_screen_includes_own_pwa_install_metadata(self):
        ...
        self.assertContains(response, 'driver-mobile-shell-v64')
        ...
        self.assertContains(response, 'class="driver-work-hold-progress-reverse"')
        self.assertContains(response, 'class="driver-work-hold-svg"')
        self.assertContains(response, 'body.driver-mobile-screen .driver-work-hold-progress-reverse')
        self.assertContains(response, 'stroke: var(--driver-cyan)')
        self.assertContains(response, 'transform: scaleY(-1)')
        self.assertContains(response, '@keyframes driver-work-hold-fill')
        self.assertContains(response, 'animation: driver-work-hold-fill 2s linear forwards')
        self.assertContains(response, 'stroke-dashoffset: 0')
    ...
    def test_driver_service_worker_caches_driver_assets_and_reports_version(self):
        ...
        self.assertIn('driver-mobile-shell-v64', script)
    ...
    def test_driver_sees_truck_loaded_event_from_excavator_realtime_shell(self):
        ...
        self.assertContains(driver_shift_response, 'driver-mobile-shell-v64')
