...
class AccessLoginTests(TestCase):
    ...
    def test_driver_screen_includes_own_pwa_install_metadata(self):
        ...
        self.assertContains(response, 'driver-mobile-shell-v57')
        ...
        self.assertContains(response, 'Math.min(54, Math.max(44, coreWidth * 0.2))')
        self.assertContains(response, 'Math.min(48, Math.max(36, coreWidth * 0.17))')
        self.assertContains(response, 'Math.min(42, Math.max(30, coreWidth * 0.15))')
        self.assertContains(response, 'Math.min(34, Math.max(26, coreWidth * 0.13))')
        self.assertContains(response, 'return 23')
        ...
        self.assertContains(response, 'text-shadow: 0 0 14px rgba(140,255,46,0.22)')
    ...
    def test_driver_service_worker_caches_driver_assets_and_reports_version(self):
        ...
        self.assertIn('driver-mobile-shell-v57', script)
    ...
    def test_driver_sees_truck_loaded_event_from_excavator_realtime_shell(self):
        ...
        self.assertContains(driver_shift_response, 'driver-mobile-shell-v57')
