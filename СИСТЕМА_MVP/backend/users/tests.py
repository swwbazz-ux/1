...
class AccessLoginTests(TestCase):
    ...
    def test_system_admin_header_uses_employee_photo_with_initial_fallback(self):
        ...
        self.assertContains(response_with_photo, 'app.css?v=ready-core-traffic-v8')
    ...
    def test_admin_employee_card_keeps_selected_role_and_primary_pin_status(self):
        ...
        self.assertContains(response, 'data-login-url="https://driverform.ru/apps/"')
        ...
        self.assertContains(response, 'css/employee-card-unified.css?v=20260824-6')
