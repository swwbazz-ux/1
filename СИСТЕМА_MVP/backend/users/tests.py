...
class AccessLoginTests(TestCase):
    ...
    def test_driver_screen_includes_own_pwa_install_metadata(self):
        ...
        self.assertContains(response, 'driver-mobile-shell-v40')
        ...
        self.assertContains(response, 'grid-template-columns: minmax(0, 1fr) minmax(104px, max-content) auto')
        self.assertContains(response, 'class="driver-header-identity"')
        ...
        self.assertContains(response, '--driver-dial-size: clamp(260px, 64vw, 390px)')
        ...
        self.assertContains(response, 'gap: clamp(18px, 2.6dvh, 30px)')
        self.assertContains(response, 'width: min(var(--driver-dial-size), 100%)')
        self.assertContains(response, 'max-width: 420px')
        ...
        self.assertContains(response, 'padding: clamp(10px, 2.2vw, 16px) 0')
        self.assertContains(response, 'inset: -3.5%')
    ...
    def test_driver_service_worker_caches_driver_assets_and_reports_version(self):
        ...
        self.assertIn('driver-mobile-shell-v40', script)
    ...
    def test_driver_sees_assigned_excavator_without_accept_action(self):
        ...
        self.assertContains(shift_response, 'ПУСТОЙ')
        self.assertContains(shift_response, '1')
        self.assertContains(shift_response, '<span>Ехать</span>', html=True)
        self.assertContains(shift_response, '<strong>—</strong>', html=True)
    ...
    def test_excavator_creates_trip_and_driver_completes_it(self):
        ...
        self.assertContains(driver_shift_response, 'ЗАГРУЖЕН')
    ...
    def test_driver_sees_truck_loaded_event_from_excavator_realtime_shell(self):
        ...
        self.assertContains(driver_shift_response, 'driver-mobile-shell-v40')
