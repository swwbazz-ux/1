...
class AccessLoginTests(TestCase):
    ...
    def test_driver_screen_includes_own_pwa_install_metadata(self):
        ...
        self.assertContains(response, 'driver-mobile-shell-v39')
        ...
        self.assertContains(response, 'grid-template-columns: minmax(0, 1fr) auto auto')
        ...
        self.assertContains(response, '--driver-dial-size: clamp(280px, 68vw, 420px)')
        ...
        self.assertContains(response, 'gap: clamp(16px, 2.4dvh, 28px)')
        ...
        self.assertContains(response, 'width: min(var(--driver-dial-size), 58dvh, 100%)')
    ...
    def test_driver_service_worker_caches_driver_assets_and_reports_version(self):
        ...
        self.assertIn('driver-mobile-shell-v39', script)
    ...
    def test_driver_sees_truck_loaded_event_from_excavator_realtime_shell(self):
        ...
        self.assertContains(driver_shift_response, 'driver-mobile-shell-v39')
