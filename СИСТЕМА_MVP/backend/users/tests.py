...
class AccessLoginTests(TestCase):
    ...
    def test_driver_screen_includes_own_pwa_install_metadata(self):
        ...
        self.assertContains(response, 'linear-gradient(180deg, rgba(70, 224, 209,0.08)')
        self.assertContains(response, 'linear-gradient(90deg, transparent, rgba(8, 58, 54,0.34)')
