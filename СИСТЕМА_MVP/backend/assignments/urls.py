...
from .deputy_views import (
    ...
    deputy_mining_manager_service_worker_view,
    deputy_mining_manager_slot_view,
    deputy_mining_manager_temporary_transfer_request_view,
)
...
urlpatterns = [
    ...
    path(
        'deputy-mining-manager/temporary-transfer/request/',
        deputy_mining_manager_temporary_transfer_request_view,
        name='deputy_mining_manager_temporary_transfer_request',
    ),
