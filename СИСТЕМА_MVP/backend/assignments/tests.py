...
class MiningMasterAssignmentsViewTests(TestCase):
    ...
    def test_mining_master_mobile_shell_includes_pwa_install_metadata(self):
        ...
        self.assertContains(response, 'data-pwa-browser-mode-warning')
        self.assertContains(response, 'Открыто не как приложение')
        self.assertContains(response, 'Яндекс Браузер запустил обычную страницу')
        self.assertContains(response, '/static/js/role-app-install-v1.js?v=2')
    ...
    def test_mining_master_service_worker_caches_pwa_assets(self):
        ...
        self.assertIn('/static/js/role-app-install-v1.js', script)
