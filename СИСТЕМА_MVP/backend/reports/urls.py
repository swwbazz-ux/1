...
from .views import (
    ...
    management_registration_dashboard_view,
...
urlpatterns = [
    ...
    path(
        'dispatcher/shift-reports/trucks/',
        dispatcher_shift_report_view,
        {'report_kind': 'trucks'},
        name='dispatcher_shift_trucks',
    ),
    path(
        'dispatcher/shift-reports/trucks/export/',
        dispatcher_shift_report_export_view,
        {'report_kind': 'trucks'},
        name='dispatcher_shift_trucks_export',
    ),
    path(
        'dispatcher/shift-reports/excavation/',
        dispatcher_shift_report_view,
        {'report_kind': 'excavation'},
        name='dispatcher_shift_excavation',
    ),
    path(
        'dispatcher/shift-reports/excavation/export/',
        dispatcher_shift_report_export_view,
        {'report_kind': 'excavation'},
    ...
    path(
        ...
        management_registration_dashboard_view,
        name='management_registration_dashboard',
    ),
