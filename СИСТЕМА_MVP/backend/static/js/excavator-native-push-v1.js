(function excavatorNativePushModule(window, document) {
    "use strict";

    if (window.__excavatorNativePushBinding) {
        window.__excavatorNativePushBinding.refresh();
        return;
    }

    var REGISTER_URL = "/excavator/push/native/";
    ...
    function identityKey(envelope, currentShell) {
        return [
            ...
            envelope.platform,
            envelope.app_id,
            String(currentShell.dataset.eoAccessId || ""),
            String(currentShell.dataset.eoEmployeeId || "")
        ].join("\n");
    }
    ...
    function register(raw) {
        ...
        if (!currentShell.dataset.eoAccessId || !currentShell.dataset.eoEmployeeId) {
    ...
    window.__excavatorNativePushBinding = binding;
