(function (root) {
    ...
    function normalizeGrid() {
        ...
        // Ряды по числу видимых карточек. Три зарезервированных ряда на один
        // самосвал держали пустую середину экрана внутри области самосвалов,
        // и точкам разгрузки её было не отдать. Высота ряда при этом прежняя,
        // поэтому сама карточка не меняется.
