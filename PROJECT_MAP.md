...
- Shell: `driver-mobile-shell-v180` (опубликован на production 02.09.2026).
...
- Shell: `excavator-mobile-shell-v177` (опубликован в production 02.09.2026).
...
- Актуальная реализация опубликована commit `711ef00c` как Driver shell `v180`
