...
## Рабочее состояние Git после ревизии 25.08.2026

- Основная рабочая ветка: `codex/recover-ready-core-local-2026-08-25`; ветка опубликована в `origin` отдельно от `main`.
- `origin/main` оставлен на `c322be0`; merge, force push и deploy при уборке не выполнялись.
- Удалены 45 исчерпанных локальных веток и 14 лишних или дублирующих worktree; уникальные незавершенные ветки сохранены.
- Точка сохранности старой основной папки: локальная ветка `codex/rescue-ready-core-local-2026-08-25`, commit `68455cc`.
- Материалы прототипа сайта и шрифты: локальная ветка `codex/site-prototype-assets-2026-08-25`, commit `4bf7221`, worktree `C:\Users\swwba\Desktop\Проект учетная система\ПОЕКТ-site-prototype-assets`.
- Контрольный полный прогон на чистом `origin/main` (`c322be0`) воспроизводит исходный результат: 2324 теста, 11 падений, 19 ошибок и 58 пропусков. Recovery-коммиты эти сбои не добавили.
...
- Shell: `driver-mobile-shell-v120`.
