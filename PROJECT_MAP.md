...
- Shell: `excavator-mobile-shell-v180` (опубликован в production 02.09.2026).
...
- Без открытой смены `Применить настройки` недоступна уже в серверной разметке
  и не отправляет запрос. Ошибки устаревшей открытой страницы показываются
  компактным fixed-уведомлением, которое не участвует в сетке и не сдвигает
  рабочую область или нижнюю навигацию.
