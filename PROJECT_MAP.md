...
- Shell: `driver-mobile-shell-v179` (опубликован на production 02.09.2026).
...
- Shell: `excavator-mobile-shell-v176` (опубликован в production 02.09.2026).
...
- Актуальная реализация опубликована commit `4fae8c68` как Driver shell `v179`
  и Excavator shell `v176`; два прежних ролевых DOM-фрагмента и дублирующие
