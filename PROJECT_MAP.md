...
- Локально собраны и подписаны профили: Водитель `0.1.8 (10)`, Машинист
  экскаватора `0.1.12 (15)`. Эти версии не считаются опубликованными, пока не
  выполнен отдельный deploy APK и серверной части.
