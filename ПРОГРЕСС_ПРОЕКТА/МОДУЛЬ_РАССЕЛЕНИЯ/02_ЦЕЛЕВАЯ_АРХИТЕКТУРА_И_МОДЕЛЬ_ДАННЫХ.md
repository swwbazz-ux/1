...
- `CONTRACTOR`, `BUSINESS_TRIP`, `EXTERNAL_OTHER`: `Employee` отсутствует, обязательны ФИО, должность/профессия, организация и телефон, фотография необязательна;
